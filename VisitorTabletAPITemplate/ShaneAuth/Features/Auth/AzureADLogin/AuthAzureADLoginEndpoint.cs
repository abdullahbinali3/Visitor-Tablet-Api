...
{
    public sealed class AuthAzureADLoginEndpoint : Endpoint<AuthAzureADLoginRequest>
    {
        ...
        public AuthAzureADLoginEndpoint(AppSettings appSettings,
        ...
        {
            Post("/auth/azureADLogin");
            SerializerContext(AuthAzureADLoginContext.Default);
            AllowAnonymous();
            Tags("IgnoreAntiforgeryToken");
        }

        public override async Task HandleAsync(AuthAzureADLoginRequest req, CancellationToken ct)
        {
            // Validate request
            ValidateInput(req);
            ...
            string redirectUri = Globals.FrontEndBaseUrl + "/sso-complete/web";
            ...
            // Check if the Azure TenantId and ObjectId are already linked to a different email
        ...
        public void ValidateInput(AuthAzureADLoginRequest req)
        {
            // Validate input
